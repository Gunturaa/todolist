...
JOIN workspace ON todo.id_goal = workspace.id_goal 
                    ...
                    <div class="card-body">
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content bg-primary">
                                    <div class="modal-header">
                                        <h6 class="modal-title">Menambahkan Todo pada Workspace</h6>
                                    ...
                                    <form action="" method="POST">
                                        <div class="modal-body bg-light">
                                            <div class="card-body">
                                                <h6>Menambahkan Todo pada Workspace</h6>
                        ...
                        <div class="card card-warning card-outline">
                            ...
                            <ul class="todo-list" data-widget="todo-list">
                                <?php
                                $id = $_GET['id_goal'];
                                $query2 = "SELECT * FROM workspace JOIN todo ON todo.id_goal = workspace.id_goal WHERE todo.id_goal='$id' AND status = 'belum'";
